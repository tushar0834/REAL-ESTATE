...
<body bgcolor="blue">
			...
			<div class="row">
				<div class="col-12">
					<div class="site-navbar">
						<a href="#" class="site-logo"><img src="LOGO.png" alt=""></a>
						...
						<ul class="main-menu">
                            ...
                            {
                                echo "<li><a href='builder.php'>Home</a></li>";
                            }
                            else
                            {
                                echo "<li><a href='BUY.php'>Home</a></li>";
                            }
                            ?>
	...
	<section class="page-section categories-page">
		<br><br>
		<h2 align="center"><a href="addprojectsale">add now</a></h2>
		...
		<div class="row">
				<?php
						$ab="select * from flat natural join sale ";
						$r1 = $conn->query($ab);
